...
public class Solution {
    ...
    public static Thread CLIENT_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                //                получаем объект (Proxy-объект)
                DoubleString service = (DoubleString) registry.lookup(UNIC_BINDING_NAME);
//                используем метод полученного объекта
                String result = service.doubleString("you");
//                выполняем условие задачи - выводим в консоль результат работы метода
