...
public class Solution {
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
//                создание реестра объектов
                registry = LocateRegistry.createRegistry(2099);
//                создание объектов
                Animal cat = new Cat("Вася");
                Animal dog = new Dog("Барбос");
//                создание заглушек для приема удаленных вызовов
                Remote stub1 = UnicastRemoteObject.exportObject(cat, 2099);
                Remote stub2 = UnicastRemoteObject.exportObject(dog, 2099);
//                регистрация заглушек в реестре
                registry.bind("Кот", stub1);
                registry.bind("Пес", stub2);
            } catch (RemoteException e) {
                e.printStackTrace();
